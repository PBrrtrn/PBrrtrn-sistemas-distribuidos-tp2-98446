    ...
    def run(self):
        ...
        while not self.finished:
            ...
            if message_type == common.network.constants.STATIONS_START:
                ...
                self.receive_and_handle_trips_batch(wrapped_socket)
                ...
                self.execute_queries(wrapped_socket)
                self.finished = True
            else:
